...
<p align="center" style="display: flex; justify-content: center; align-items: center; background-color: #1a1a1a; padding: 5px; border-radius: 6px; width: fit-content; margin: 20px auto;">
    ...
    <span style="margin: 0 10px; color: white; font-size: 14px;">B</span>
    <img src="https://github.com/user-attachments/assets/09cfc307-f04f-4225-8c3b-bc96c47583a6" alt="EasyA" style="width: 175px;"/>
</p>
